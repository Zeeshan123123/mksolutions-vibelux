...
export class DemoDataGenerator {
  ...
  static getDemoCredentials() {
    // Note: Demo credentials should not be hardcoded in production
    // This should be replaced with proper demo account management
    return {
      email: 'demo@vibelux.com',
      message: 'Demo credentials are managed through environment configuration',
    };
  }
