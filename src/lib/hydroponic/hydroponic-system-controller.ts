...
export class HydroponicSystemController {
  ...
  private async doseNutrients(type: string, amount: number): Promise<void> {
    ...
    logger.info('api', `Dosed ${amount}mL of ${type}`);
  }
  ...
  public startSystem(): void {
    this.isRunning = true;
    logger.info('api', `Hydroponic system ${this.config.systemId} started`);
  }

  public stopSystem(): void {
    this.isRunning = false;
    logger.info('api', `Hydroponic system ${this.config.systemId} stopped`);
  }
  ...
  public updateConfig(newConfig: Partial<HydroponicSystemConfig>): void {
    ...
    logger.info('api', `Configuration updated for system ${this.config.systemId}`);
  }
