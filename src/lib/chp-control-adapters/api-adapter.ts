  ...
  private setupAuthentication(): void {
    switch (this.apiConfig.authType) {
      ...
      case 'oauth2':
        ...
        logger.warn('api', 'OAuth2 authentication not fully implemented')
        break
    }
  }
    ...
    try {
      ...
      ws.onmessage = (event) => {
        try {
          ...
          logger.error('api', 'Error parsing WebSocket message:', error )
        }
      }
      ...
      logger.error('api', 'Failed to establish WebSocket connection:', error )
    }
  }
}
