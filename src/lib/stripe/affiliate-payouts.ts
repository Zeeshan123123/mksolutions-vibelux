...
export class StripeAffiliatePayouts {
  ...
  static async createAffiliateAccount(
    ...
    try {
      ...
      logger.error('api', 'Failed to create Stripe affiliate account:', error );
  ...
  static async createOnboardingLink(
    ...
    try {
      ...
      logger.error('api', 'Failed to create onboarding link:', error );
  ...
  static async updateAccountStatus(stripeAccountId: string): Promise<Partial<StripeAffiliateAccount>> {
    try {
      ...
      logger.error('api', 'Failed to update account status:', error );
  ...
  static async processAffiliatePayout(
    ...
    try {
      ...
      logger.error('api', 'Failed to process affiliate payout:', error );
