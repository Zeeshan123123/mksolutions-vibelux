...
export class AIComplianceAssistant {
  ...
  async assessCompliance(
    ...
    logger.info('api', `Assessing ${framework.name} compliance for facility ${facilityId}`);
  ...
  async generateComplianceDocument(
    ...
    logger.info('api', `Generating ${type} document for ${framework} compliance`);
    ...
    try {
      ...
      logger.error('api', 'Error generating compliance document:', error );
      throw error;
    }
  }
  ...
  async getComplianceGuidance(
    ...
    try {
      ...
      logger.error('api', 'Error getting compliance guidance:', error );
  ...
  async generateRemediationPlan(
    ...
    logger.info('api', `Generating remediation plan for ${gaps.length} compliance gaps`);
    ...
    try {
      ...
      logger.error('api', 'Error generating remediation plan:', error );
      throw error;
    }
  }
  ...
  async generateTrainingContent(
    ...
    try {
      ...
      logger.error('api', 'Error generating training content:', error );
      throw error;
    }
  }
