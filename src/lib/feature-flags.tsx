...
export class FeatureFlagService {
  ...
  async isEnabled(
    ...
    try {
      ...
      logger.error('system', `Error checking feature flag ${flagKey}:`, error instanceof Error ? error : undefined, error instanceof Error ? undefined : { error })
  ...
  async getValue<T = any>(
    ...
    try {
      ...
      logger.error('system', `Error getting feature flag value ${flagKey}:`, error instanceof Error ? error : undefined, error instanceof Error ? undefined : { error })
      return defaultValue
    }
  }
  ...
  async getAllFlags(context: FeatureFlagContext = {}): Promise<Record<string, boolean>> {
    try {
      ...
      logger.error('system', 'Error getting all feature flags:', error )
      return {}
    }
  }
