...
export const co2Database: Record<string, CO2System> = {
  ...
  // CAP (C.A.P.) - Major CO₂ equipment manufacturer
  'cap-mgh-4': {
    id: 'cap-mgh-4',
    manufacturer: 'CAP',
    model: 'MGH-4',
  ...
  // Johnson Controls - Industrial CO₂ systems
  'johnson-controls-cd-7100': {
    id: 'johnson-controls-cd-7100',
  ...
  // Vaisala - Professional CO₂ sensors
  'vaisala-gmp252': {
    id: 'vaisala-gmp252',
  ...
  // Dwyer Instruments - CO₂ monitoring and control
  'dwyer-cdp-2r': {
    id: 'dwyer-cdp-2r',
  ...
  // Honeywell - Building automation CO₂ systems
  'honeywell-c7400d1000': {
    id: 'honeywell-c7400d1000',
