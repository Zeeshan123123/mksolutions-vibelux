...
export class PrivaAdapter {
  ...
  async connect(): Promise<boolean> {
    try {
      ...
      logger.error('api', 'Failed to connect to Priva system:', error );
      return false;
    }
  }
  ...
  private async connectToCloud(): Promise<boolean> {
    try {
      ...
      logger.error('api', 'Priva Cloud connection failed:', error );
      return false;
    }
  }
  ...
  private async connectToOnPremise(): Promise<boolean> {
    try {
      ...
      logger.error('api', 'Priva Modbus connection failed:', error );
      return false;
    }
  }
