...
export class ArgusAdapter {
  ...
  async connect(): Promise<boolean> {
    try {
      ...
      logger.error('api', 'Failed to connect to Argus system:', error );
      return false;
    }
  }
  ...
  private async connectModbus(): Promise<boolean> {
    try {
      ...
      logger.error('api', 'Argus Modbus connection failed:', error );
      return false;
    }
  }
  ...
  private async connectWebAPI(): Promise<boolean> {
    try {
      ...
      logger.error('api', 'Argus Web API connection failed:', error );
      return false;
    }
  }
  ...
  private async readModbusDataPoint(pointId: string): Promise<ArgusDataPoint | null> {
    ...
    try {
      ...
      logger.error('api', `Failed to read Modbus point ${pointId}:`, error);
      return null;
    }
  }
