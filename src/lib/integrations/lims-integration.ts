...
export class LIMSIntegrationService {
  ...
  private async fetchConfidentCannabisResults(
    ...
    try {
      ...
      logger.error('api', 'Confident Cannabis API error:', error );
  ...
  private async fetchSteepHillResults(
    ...
    try {
      ...
      logger.error('api', 'Steep Hill API error:', error );
  ...
  private async fetchSCLabsResults(
    ...
    try {
      ...
      logger.error('api', 'SC Labs API error:', error );
  ...
  private async fetchLabwareResults(
    ...
    try {
      ...
      logger.error('api', 'LabWare API error:', error );
