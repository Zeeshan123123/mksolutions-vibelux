...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (isSignedIn) {
      ...
      // Default to free tier for now - this would normally come from user metadata
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#000000', color: '#ffffff' }}>
      {/* Success Message */}
      {showSuccessMessage && (
        <div className="fixed top-4 right-4 z-50 bg-green-900/90 border border-green-600 rounded-lg p-4 shadow-xl max-w-md">
          <div className="flex items-start gap-3">
            <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0 mt-0.5" />
            <div className="flex-1">
              <h3 className="text-white font-semibold mb-1">Subscription Activated!</h3>
          ...
          <div className="flex justify-between items-center h-16">
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <p style={{ color: '#9ca3af' }}>Welcome back, User</p>
                <span style={{ 
                  fontSize: '0.75rem', 
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                ...
                >
                  <Gauge style={{ height: '0.875rem', width: '0.875rem' }} />
                  PSI Monitor
                </Link>
                <Link
