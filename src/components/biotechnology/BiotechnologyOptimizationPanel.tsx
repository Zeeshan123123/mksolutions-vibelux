...
export function BiotechnologyOptimizationPanel({ onOptimizationComplete }: BiotechnologyOptimizationPanelProps) {
  ...
  const runOptimization = async () => {
    ...
    try {
      logger.info('system', 'Starting biotechnology optimization...');
  ...
  const runQuantumOptimization = async () => {
    logger.info('system', 'Running quantum-enhanced biotechnology optimization...');
  ...
  const runClassicalOptimization = async () => {
    logger.info('system', 'Running classical biotechnology optimization...');
