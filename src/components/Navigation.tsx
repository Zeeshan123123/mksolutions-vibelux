...
export default function Navigation({ onClose }: NavigationProps) {
  ...
  const navLinks = [
    { href: '/unified-dashboard', label: '🚀 Unified Dashboard', permission: 'canAccessAdvanced' },
    { href: '/documents', label: '📄 Document Management', highlight: true },
    { href: '/features/document-management', label: 'Document Features', badge: 'NEW' },
    { href: '/templates', label: '📋 Quick Templates', badge: 'FREE' },
    { href: '/features', label: 'Features' },
    { href: '/fixtures', label: 'Fixtures', permission: 'canAccessFixtures' },
    { href: '/research', label: 'Research Suite', permission: 'canAccessAdvanced' },
    { href: '/professional-reporting', label: 'Professional Reports', permission: 'canAccessReports' },
    { href: '/marketplace', label: 'B2B Marketplace' },
    { href: '/energy-optimization', label: 'Energy Optimization' },
    { href: '/climate-intelligence', label: 'Climate Intelligence' },
        ...
        <div className="space-y-2">
          {navLinks.map(link => (
            <Link 
              key={link.href}
              href={link.href} 
              className={`block px-3 py-2 rounded-lg font-medium transition-colors relative ${
                pathname === link.href 
                  ? 'text-white bg-purple-600' 
                  : link.highlight
                  ? 'text-white bg-gradient-to-r from-purple-600 to-purple-700 shadow-lg shadow-purple-500/25'
