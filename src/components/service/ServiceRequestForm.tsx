...
export default function ServiceRequestForm({ 
  ...
  const fetchFacilities = async () => {
    try {
      ...
      logger.error('system', 'Error fetching facilities:', error );
    }
  };
  ...
  const fetchEquipment = async (facilityId: string) => {
    try {
      ...
      logger.error('system', 'Error fetching equipment:', error );
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      logger.error('system', 'Error submitting service request:', error );
    } finally {
      setLoading(false);
    }
  };
