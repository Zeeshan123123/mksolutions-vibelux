  ...
  return (
    <div className="w-full h-[600px] bg-gray-900 rounded-lg overflow-hidden">
      ...
      <Canvas shadows camera={{ position: [10, 10, 10], fov: 45 }}>
        ...
        {/* Sensor nodes */}
        <RadioNode position={[-3, 2, -3]} type="temperature" value={24.5} />
        <RadioNode position={[3, 2, -3]} type="humidity" value={65.2} />
        <RadioNode position={[-3, 2, 3]} type="co2" value={1200} />
        <RadioNode position={[3, 2, 3]} type="ph" value={6.2} />
