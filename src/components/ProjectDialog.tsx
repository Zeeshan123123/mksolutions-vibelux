...
export function ProjectDialog({ 
  ...
  const loadProjects = async () => {
    ...
    try {
      ...
      logger.error('system', 'Failed to load projects:', error );
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      logger.error('system', 'Failed to save project:', error );
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleLoad = async () => {
    ...
    try {
      ...
      logger.error('system', 'Failed to load project:', error );
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async (projectId: string) => {
    ...
    try {
      ...
      logger.error('system', 'Failed to delete project:', error );
    }
  };
