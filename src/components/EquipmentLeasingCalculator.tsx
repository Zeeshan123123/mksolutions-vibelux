...
import { generateProfessionalLeasingReport } from '@/lib/pdf/equipment-leasing-report'
...
export function EquipmentLeasingCalculator() {
  ...
  const handleExportPDF = () => {
    const reportHTML = generateProfessionalLeasingReport({
      equipment,
      leaseOptions,
      selectedOption,
      comparison,
    ...
    exportToPDF(reportHTML, `VibeLux_Leasing_Analysis_${equipment.name.replace(/\s+/g, '_')}.pdf`)
  }
