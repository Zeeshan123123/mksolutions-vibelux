...
export function designerReducer(state: DesignerState, action: DesignerAction): DesignerState {
  ...
  switch (action.type) {
    ...
    case 'ADD_COGENERATION_COMPONENT': {
      return {
        ...state,
        cogenerationComponents: [
          ...(state.cogenerationComponents || []),
          action.payload
        ]
      };
    }

    case 'UPDATE_COGENERATION_COMPONENT': {
      return {
        ...state,
        cogenerationComponents: (state.cogenerationComponents || []).map(component =>
    ...
    case 'DELETE_COGENERATION_COMPONENT': {
      return {
        ...state,
        cogenerationComponents: (state.cogenerationComponents || []).filter(
