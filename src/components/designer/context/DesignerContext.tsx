...
export function DesignerProvider({ children, initialSpaceType, initialDimensions }: DesignerProviderProps) {
  const modifiedInitialState = {
    ...initialState,
    room: {
      ...initialState.room,
      spaceType: initialSpaceType || 'indoor',
      ...(initialDimensions && {
        length: initialDimensions.length,
        width: initialDimensions.width,
        height: initialDimensions.height,
        ceilingHeight: initialDimensions.height
      })
    }
  };
  
  const [state, dispatch] = useReducer(designerReducer, modifiedInitialState);
