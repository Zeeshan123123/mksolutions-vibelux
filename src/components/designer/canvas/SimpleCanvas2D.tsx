...
export function SimpleCanvas2D() {
  ...
  const handleCanvasClick = useCallback((event: React.MouseEvent<HTMLCanvasElement>) => {
    logger.info('system', 'Canvas clicked!', { data: {
      hasRoom: !!room, hasCanvas: !!canvasRef.current, selectedTool: ui.selectedTool, selectedFixture: ui.selectedFixtureModel
    } });
    ...
    logger.info('system', 'About to place fixture:', { data: selectedFixture });
    if (!selectedFixture) {
    ...
    if (selectedFixture.type === 'hvacFan') {
      ...
      logger.info('system', 'Adding fixture object:', { data: fixture });
      addObject(fixture);
      showNotification('success', `Placed ${selectedFixture.brand} ${selectedFixture.model}`);
      logger.info('system', 'Fixture placed successfully');
    }
