...
function SensorsPageComponent() {
  ...
  const designFixtures = currentDesign ? getFixturesForSensor() : []
  const fixtures = designFixtures.length > 0 
    ? designFixtures.map(f => ({ x: f.x, y: f.y, z: f.z, ppf: 1800, beamAngle: 120 }))
    : [
