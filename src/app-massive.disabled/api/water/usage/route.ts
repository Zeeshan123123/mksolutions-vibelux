...
import { requireFacilityAccess } from '@/lib/auth-helpers'

export async function GET(request: Request) {
  const { error, userId, facility } = await requireFacilityAccess()
  ...
  try {
    ...
    logger.error('api', 'Error fetching water usage data:', error )
    return NextResponse.json(
...
export async function POST(request: Request) {
  ...
  try {
    ...
    logger.error('api', 'Error recording water usage:', error )
    return NextResponse.json(
