...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      logger.error('api', 'Stripe Connect error:', stripeError);
    ...
    logger.error('api', 'Error setting up Stripe Connect:', error );
    return NextResponse.json(
...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('api', 'Error fetching Stripe Connect status:', error );
    return NextResponse.json(
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    try {
      ...
      logger.error('api', 'Error disconnecting Stripe account:', stripeError);
      throw stripeError;
    }

  } catch (error) {
    logger.error('api', 'Error disconnecting Stripe Connect:', error );
    return NextResponse.json(
