...
export async function POST(request: NextRequest) {
  try {
    ...
    // Analyze harvest quality using Google Vision - TODO: Implement gradeHarvestQuality method
    ...
    logger.info('api', `Harvest quality analysis:`, { data: {
      facilityId, zoneId, strainName, grade: qualityAnalysis.overallGrade, trichomeMaturity: qualityAnalysis.trichomeAnalysis.maturity, hasDefects: qualityAnalysis.colorProfile.hasDefects
    } });

    return NextResponse.json(enhancedAnalysis);

  } catch (error: any) {
    logger.error('api', 'Harvest quality analysis error:', error );
    return NextResponse.json(
      { 
