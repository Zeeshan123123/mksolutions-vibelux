              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-lg font-medium">{identifiedPlant.commonNames?.[0] || 'Unknown'}</p>
                  </div>
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 bg-gray-800 rounded-full h-2">
                        <div 
                          ...
                          style={{ width: `${identifiedPlant.confidence * 100}%` }}
                        />
                      </div>
                      <span className="text-sm">{(identifiedPlant.confidence * 100).toFixed(1)}%</span>
                    </div>
                  </div>
                </div>
              </div>
