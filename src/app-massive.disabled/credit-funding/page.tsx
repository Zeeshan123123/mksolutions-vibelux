...
import { CreditDashboard } from '@/components/CreditDashboard.stub';
import { MilestoneFunding } from '@/components/MilestoneFunding';
import { RegionalPools } from '@/components/RegionalPools';
import { ReferralDashboard } from '@/components/ReferralDashboard.stub';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
          ...
          <TabsContent value="pools">
            <RegionalPools facilityId="demo-facility" userId={userId!} region="Pacific Northwest" />
          </TabsContent>
