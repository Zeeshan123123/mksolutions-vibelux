...
export default function SpectrumOptimizationPage() {
  ...
  const calculateMetrics = () => {
    ...
    return {
      total,
      blueRedRatio: blueRed,
      redFarRedRatio: redFarRed,
      efficiency: (customSpectrum.blue + customSpectrum.red) / total * 100,
      // Display formatted versions
      blueRedRatioDisplay: blueRed.toFixed(2),
      redFarRedRatioDisplay: redFarRed.toFixed(2),
      efficiencyDisplay: ((customSpectrum.blue + customSpectrum.red) / total * 100).toFixed(1)
    };
  };
              ...
              <div className="pt-4 border-t border-gray-700">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-bold">{metrics.blueRedRatioDisplay}</p>
                  </div>
                  <div>
                    <p className="text-gray-400">Red:Far-Red</p>
                    <p className="font-bold">{metrics.redFarRedRatioDisplay}</p>
                  </div>
                  <div>
                    <p className="text-gray-400">PAR Efficiency</p>
                    <p className="font-bold">{metrics.efficiencyDisplay}%</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <Card className="bg-gray-800 border-gray-700">
                      <CardContent className="p-4">
                        ...
                        <p className="text-2xl font-bold">{metrics.efficiencyDisplay}%</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-gray-800 border-gray-700">
                      <CardContent className="p-4">
                        ...
                        <p className="text-2xl font-bold">{metrics.blueRedRatioDisplay}</p>
                      </CardContent>
                    </Card>
