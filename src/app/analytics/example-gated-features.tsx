...
export default function AnalyticsWithGatedFeatures() {
  ...
  const mlAccess = useModuleAccess(ModuleType.PROFESSIONAL);
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <ModuleFeatureGate 
        module={ModuleType.PROFESSIONAL}
        soft={true}
        customMessage="ML-powered predictions require the Professional tier or above"
      >
        <div className="bg-gray-800 rounded-lg p-6">
          <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
