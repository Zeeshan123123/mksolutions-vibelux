...
export default function EnergyPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* How It Works */}
      <HowItWorksStrip
        heading="How Energy Optimization Works"
        subheading="Connect → Establish seasonal baseline → Optimize schedules → Verify savings."
        planNotice="Energy Savings Program is free; paid plans unlock advanced monitoring & automation"
        steps={[
          { title: 'Connect/Upload Bills', description: 'Utility API or PDF parsing to seed baselines', href: '/integrations/utility-api?tab=connections', ctaLabel: 'Connect' },
          { title: 'Seasonal Baselines', description: 'Monthly values + manual adjustments for ops changes', href: '/energy/setup/utility', ctaLabel: 'Configure' },
          { title: 'Optimization', description: 'Demand response, peak shifting, battery/solar coordination', href: '/energy-monitoring', ctaLabel: 'Open Monitoring' },
          { title: 'Verified Savings', description: 'Track savings and revenue share payouts', href: '/pricing', ctaLabel: 'Program Terms' },
        ]}
      />
