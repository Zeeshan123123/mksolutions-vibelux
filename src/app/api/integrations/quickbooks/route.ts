...
const QuickBooksIntegration = {
  getInstance: () => ({
    ...
    createInvoice: async (...args: any[]) => ({ id: 'mock-invoice' }),
    syncHarvestBatch: async (...args: any[]) => ({ success: true }),
    syncExpenses: async (...args: any[]) => ({ success: true }),
    createCustomer: async (...args: any[]) => ({ id: 'mock-customer' }),
    createItem: async (...args: any[]) => ({ id: 'mock-item' }),
    createExpense: async (...args: any[]) => ({ id: 'mock-expense' }),
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const qb = QuickBooksIntegration.getInstance();
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    logger.error('api', 'QuickBooks operation error:', error )
    return NextResponse.json(
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    logger.error('api', 'QuickBooks configuration error:', error )
    return NextResponse.json(
