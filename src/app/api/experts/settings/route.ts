...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('api', 'Error fetching expert settings:', error );
    return NextResponse.json(
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (emailNotifications) {
      ...
      logger.info('api', 'Email notification preferences updated:', { data: emailNotifications });
    }
    ...
    logger.error('api', 'Error updating expert settings:', error );
    return NextResponse.json(
