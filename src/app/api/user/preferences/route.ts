...
export async function GET(request: NextRequest) {
  try {
    ...
    const preferences = initializeDefaultPreferences(userId, 'user@example.com');
    ...
    logger.error('api', 'Error fetching user preferences:', error );
    return NextResponse.json(
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const currentPrefs = initializeDefaultPreferences(userId, 'user@example.com');
    ...
    for (const [section, sectionData] of Object.entries(updateData)) {
      ...
      if (section in updatedPrefs && typeof sectionData === 'object' && sectionData !== null) {
  ...
  try {
    ...
    switch (action) {
      case 'reset_to_defaults':
        ...
        const defaultPrefs = initializeDefaultPreferences(userId, 'user@example.com');
        return NextResponse.json({
          success: true,
    ...
    logger.error('api', 'Error processing preferences action:', error );
    return NextResponse.json(
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    logger.error('api', 'Error deleting preferences section:', error );
    return NextResponse.json(
