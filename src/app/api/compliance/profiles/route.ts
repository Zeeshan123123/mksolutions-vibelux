...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error('api', 'Error fetching compliance profiles:', error );
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error('api', 'Error creating compliance profile:', error );
    return NextResponse.json(
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.error('api', 'Error updating compliance profile:', error );
    return NextResponse.json(
