...
// Map Stripe price IDs to VibeLux tier names
function getTierFromPriceId(priceId: string): string {
  const priceToTierMap: Record<string, string> = {
    [process.env.STRIPE_SOLO_MONTHLY_PRICE_ID!]: 'design-solo',
    [process.env.STRIPE_SOLO_ANNUAL_PRICE_ID!]: 'design-solo',
    ...
    [process.env.STRIPE_GROWER_MONTHLY_PRICE_ID!]: 'starter',
    [process.env.STRIPE_GROWER_ANNUAL_PRICE_ID!]: 'starter',
    [process.env.STRIPE_BUSINESS_MONTHLY_PRICE_ID!]: 'enterprise',
    [process.env.STRIPE_BUSINESS_ANNUAL_PRICE_ID!]: 'enterprise',
  };
...
async function handleSubscriptionCreated(subscription: Stripe.Subscription) {
  try {
    ...
    // Determine tier from price ID using new mapping
...
function getPlanFromPriceId(priceId: string): string {
  ...
  const priceMap: Record<string, string> = {
    // New unified tiers
    [process.env.NEXT_PUBLIC_STRIPE_DESIGN_SOLO_MONTHLY_PRICE_ID!]: 'DESIGN SOLO',
    [process.env.NEXT_PUBLIC_STRIPE_DESIGN_SOLO_ANNUAL_PRICE_ID!]: 'DESIGN SOLO',
    ...
    [process.env.NEXT_PUBLIC_STRIPE_TEAMS_MONTHLY_PRICE_ID!]: 'TEAMS',
    [process.env.NEXT_PUBLIC_STRIPE_TEAMS_ANNUAL_PRICE_ID!]: 'TEAMS',
    [process.env.NEXT_PUBLIC_STRIPE_PROFESSIONAL_MONTHLY_PRICE_ID!]: 'PROFESSIONAL',
    [process.env.NEXT_PUBLIC_STRIPE_PROFESSIONAL_ANNUAL_PRICE_ID!]: 'PROFESSIONAL',
    [process.env.NEXT_PUBLIC_STRIPE_ENTERPRISE_MONTHLY_PRICE_ID!]: 'ENTERPRISE',
    [process.env.NEXT_PUBLIC_STRIPE_ENTERPRISE_ANNUAL_PRICE_ID!]: 'ENTERPRISE',

    // Legacy/env compatibility (map to nearest modern tier)
    [process.env.NEXT_PUBLIC_STRIPE_PRICE_ESSENTIAL!]: 'STARTER',
    [process.env.NEXT_PUBLIC_STRIPE_PRICE_PROFESSIONAL!]: 'PROFESSIONAL',
    [process.env.STRIPE_PROFESSIONAL_MONTHLY_PRICE_ID!]: 'PROFESSIONAL',
    [process.env.STRIPE_PROFESSIONAL_ANNUAL_PRICE_ID!]: 'PROFESSIONAL',
    [process.env.STRIPE_BUSINESS_MONTHLY_PRICE_ID!]: 'PROFESSIONAL',
    [process.env.STRIPE_BUSINESS_ANNUAL_PRICE_ID!]: 'PROFESSIONAL',
    [process.env.STRIPE_GROWER_MONTHLY_PRICE_ID!]: 'PROFESSIONAL',
    [process.env.STRIPE_GROWER_ANNUAL_PRICE_ID!]: 'PROFESSIONAL',

    // Query packages (maintain professional access)
    [process.env.NEXT_PUBLIC_STRIPE_QUERIES_25_PRICE_ID!]: 'PROFESSIONAL',
    [process.env.NEXT_PUBLIC_STRIPE_QUERIES_100_PRICE_ID!]: 'PROFESSIONAL',
    [process.env.NEXT_PUBLIC_STRIPE_QUERIES_500_PRICE_ID!]: 'PROFESSIONAL'
  };
  
  // Filter out undefined values and return the tier
  for (const [envPriceId, tier] of Object.entries(priceMap)) {
