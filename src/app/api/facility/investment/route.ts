...
export async function GET(request: Request) {
  try {
    ...
    logger.error('api', 'Error fetching facility opportunities:', error );
...
export async function POST(request: Request) {
  try {
    ...
    logger.error('api', 'Error creating opportunity:', error );
    return NextResponse.json(
...
export async function PUT(request: Request) {
  try {
    ...
    logger.error('api', 'Error updating opportunity:', error );
    return NextResponse.json(
