...
interface AutomationConfig {
  ...
  constraints?: any; // Permissive to handle all the complex nested properties
  targets?: any; // For targets configuration
  safety?: any; // For safety configuration
  schedule?: any; // For scheduling
  settings?: any;
}
...
export async function POST(
  ...
  try {
    ...
    logger.error('api', 'Error in automation API:', error );
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    logger.error('api', 'Error updating automation config:', error );
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    logger.error('api', 'Error terminating automation:', error );
    return NextResponse.json(
