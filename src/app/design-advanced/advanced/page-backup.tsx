...
const SmartGreenhouseSetupWizard = lazy(() => import('@/components/SmartGreenhouseSetupWizard').then(module => ({ default: module.SmartGreenhouseSetupWizard })));
const AIDesignCreditEstimator = lazy(() => import('@/components/ai/AIDesignCreditEstimator'));
