...
export default function CalculatorsPageEnhanced() {
  const calculatorCategories = [
    ...
    {
      category: "Aquaculture & Aquaponics",
      icon: Fish,
      calculators: [
        {
          title: "RAS System Calculator",
          description: "Design recirculating aquaculture systems with biofilter sizing",
          icon: Fish,
          color: "from-blue-600/20 to-indigo-600/20",
          borderColor: "border-blue-600/20",
          link: "/calculators/aquaculture",
          features: ["Tank sizing", "Biofilter calculations", "Flow rate optimization", "Species-specific"],
          new: true
        },
        {
          title: "Aquaponics Balance",
          description: "Balance fish production with plant nutrient requirements",
          icon: Leaf,
          color: "from-teal-500/20 to-green-500/20",
          borderColor: "border-teal-500/20",
          link: "/calculators/aquaponics",
          features: ["Fish-to-plant ratios", "Nutrient modeling", "pH management", "System cycling"],
          new: true
        }
      ]
    }
