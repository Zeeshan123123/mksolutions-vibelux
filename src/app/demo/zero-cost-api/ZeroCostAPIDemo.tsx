...
const CldImage = dynamicImport(() => import('next-cloudinary').then(m => m.CldImage), { ssr: false });
// Avoid mapbox imports during SSR
...
const MapboxDemo = dynamicImport(() => import('@/components/demos/MapboxDemo').then(mod => mod.MapboxDemo), { ssr: false });
const NotificationDemo = dynamicImport(() => import('@/components/demos/NotificationDemo').then(mod => mod.NotificationDemo), { ssr: false });
const HybridMLDemo = dynamicImport(() => import('@/components/demos/HybridMLDemo').then(mod => mod.HybridMLDemo), { ssr: false });
const PerformanceDemo = dynamicImport(() => import('@/components/demos/PerformanceDemo').then(mod => mod.PerformanceDemo), { ssr: false });
