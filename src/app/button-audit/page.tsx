        ...
        <div className="mt-8 flex gap-4 justify-end">
          <button 
            onClick={() => {
              ...
              const csvString = [
                ['Component', 'Issue', 'Severity', 'Line', 'Suggestion'].join(','),
              ...
              a.href = url;
              a.download = 'button-audit-report.csv';
          ...
          <button 
            onClick={() => {
              // For PDF export, we'll generate a simple text report
              const reportText = [
                'VibeLux Button Audit Report',
                '='.repeat(30),
                `Total Issues: ${BUTTON_ISSUES.length}`,
              ...
              const a = document.createElement('a');
              a.href = url;
              a.download = 'button-audit-report.txt';
              document.body.appendChild(a);
              a.click();
              document.body.removeChild(a);
              URL.revokeObjectURL(url);
          ...
          <button 
            onClick={async () => {
              ...
              const report = {
                ...
                summary: {
                  totalIssues: BUTTON_ISSUES.length,
                  errors: severityCounts.error,
                  warnings: severityCounts.warning,
                  info: severityCounts.info
                },
                ...
                recommendations: [
                  'Implement Centralized Button Handler',
              ...
              const a = document.createElement('a');
              a.href = url;
              a.download = 'button-audit-full-report.json';
              document.body.appendChild(a);
              a.click();
              document.body.removeChild(a);
              URL.revokeObjectURL(url);
