...
export default function PricingQuiz() {
  ...
  const handleAnswer = (optionIndex: number) => {
    try {
      ...
      logger.error('system', 'Error handling answer:', error );
    }
  };
  ...
  const goBack = () => {
    try {
      ...
      logger.error('system', 'Error going back:', error );
    }
  };
  ...
  const getRecommendedTier = () => {
    try {
      ...
      logger.error('system', 'Error getting recommended tier:', error );
      return tiers[0];
    }
  };
  ...
  const getSortedTiers = () => {
    try {
      ...
      logger.error('system', 'Error sorting tiers:', error );
      return tiers;
    }
  };
