...
export default function EmailCampaignsPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    audienceType: 'all' as 'all' | 'segment' | 'tier' | 'custom',
    segments: [] as string[],
    tiers: [] as string[],
    templateId: '',
    content: {
  ...
  async function loadCampaigns() {
    try {
      ...
      logger.error('system', 'Error loading campaigns:', error )
  ...
  async function loadTemplates() {
    try {
      ...
      logger.error('system', 'Error loading templates:', error )
  ...
  async function sendTestEmail(campaignId: string, testEmail: string) {
    try {
      ...
      logger.error('system', 'Error sending test email:', error )
    }
  }
  ...
  async function sendCampaign(campaignId: string) {
    ...
    try {
      ...
      logger.error('system', 'Error sending campaign:', error )
    }
  }
  ...
  async function deleteCampaign(campaignId: string) {
    ...
    try {
      ...
      logger.error('system', 'Error deleting campaign:', error )
    }
  }
            ...
            <div className="bg-gray-800 rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="bg-white rounded-lg p-6">
                <div dangerouslySetInnerHTML={{ 
                  __html: sanitizeWithNonce(selectedCampaign.content.html, nonce)
                }} />
              </div>
            </div>
          </div>
