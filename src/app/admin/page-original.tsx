...
import { Shield, Users, Activity, Search, UserCheck, AlertTriangle, LogOut, Eye, Database, TrendingUp, Settings, Flag, BarChart3, MessageSquare, FileText, DollarSign, Bot, Gift } from 'lucide-react';
import { AdminDashboardOverview } from '@/components/admin/DebugDashboard';
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    async function checkAdmin() {
      ...
      try {
        ...
        logger.error('system', 'Error checking admin access:', error );
        router.push('/');
      } finally {
        setLoading(false);
      }
  ...
  async function fetchUsers() {
    try {
      ...
      logger.error('system', 'Error fetching users:', error );
    }
  }
  ...
  async function fetchAuditLogs() {
    try {
      ...
      logger.error('system', 'Error fetching audit logs:', error );
    }
  }
  ...
  async function checkCurrentImpersonation() {
    try {
      ...
      logger.error('system', 'Error checking impersonation status:', error );
    }
  }
  ...
  async function startImpersonation(targetUserId: string) {
    ...
    try {
      ...
      logger.error('system', 'Error starting impersonation:', error );
  ...
  async function endImpersonation() {
    try {
      ...
      logger.error('system', 'Error ending impersonation:', error );
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Show overview when no user is selected */}
        {!selectedUser && (
          <div className="mb-8">
