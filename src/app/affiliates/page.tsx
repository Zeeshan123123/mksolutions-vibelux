...
export default function AffiliatesPage() {
  ...
  const loadDashboard = async () => {
    try {
      ...
      logger.error('system', 'Error loading dashboard:', error )
    }
  }
  ...
  const loadLinks = async () => {
    try {
      ...
      logger.error('system', 'Error loading links:', error )
    } finally {
      setIsLoading(false)
    }
  }
  ...
  const createLink = async () => {
    try {
      ...
      logger.error('system', 'Error creating link:', error )
  ...
  const copyToClipboard = async (text: string) => {
    try {
      ...
      logger.error('system', 'Failed to copy:', error )
    }
  }
