...
const mockListings: Partial<ProduceListing>[] = [
  {
    ...
    availability: { 
      ...
      availableUntil: new Date('2024-01-30'),
      recurring: true,
      frequency: 'weekly'
    },
    pricing: { price: 2.50, unit: 'head', contractPricing: false },
    status: 'active'
  },
  {
    id: '2',
    ...
    availability: { 
      ...
      unit: 'lbs',
      harvestDate: new Date('2024-01-19'),
      availableFrom: new Date('2024-01-19'),
      availableUntil: new Date('2024-01-26'),
      recurring: false
    },
    pricing: { price: 4.99, unit: 'lb', contractPricing: false },
    status: 'active'
  }
];
