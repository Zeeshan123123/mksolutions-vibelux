...
CREATE TABLE IF NOT EXISTS "TrialLicenseListing" (
  ...
  -- NOTE: FK to "User" omitted for compatibility when Prisma user table isn't deployed
  "ownerId" TEXT NOT NULL,
  "title" TEXT NOT NULL,
  "summary" TEXT,
  "licenseType" TEXT NOT NULL, -- ONE_TIME_LICENSE | ROYALTY_BASED | SUBSCRIPTION | CUSTOM
  "usageRights" TEXT NOT NULL, -- PERSONAL | COMMERCIAL | UNLIMITED | RESEARCH_ONLY
